...
SWEP.Description = [[A modernized iteration of the classic Kalashnikov rifle, the AK-12 offers improved ergonomics, modularity, and accuracy while maintaining legendary reliability.]]
SWEP.Trivia = {
...
SWEP.ViewModel = "models/weapons/arc9/c_gst_ak12.mdl"
SWEP.WorldModel = "models/weapons/w_rif_m4a1.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/w_gst_ak12.mdl"
...
SWEP.ShootSound = "ARC9_Ghosts.AK12_Fire"
SWEP.ShootSoundSilenced = "ARC9_Ghosts.Badger_Fire"
SWEP.DistantShootSound = "ARC9_Ghosts.AK12_Mech"
SWEP.Silencer = false
...
local ironsightpos = Vector(-2.55, -2, 1.65)
...
SWEP.HookP_NameChange = function(self, name)
    ...
    if attached["bo1_pap"] then
        gunname = "Reznov's Reconstruction"
    end
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "ARC9_Ghosts.AK12_MagOut", t = 0.8},
            {s = "ARC9_Ghosts.AK12_MagIn", t = 1.8},
        },
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        EventTable = {
            {s = "ARC9_Ghosts.AK12_MagOut", t = 0.8},
            {s = "ARC9_Ghosts.AK12_MagIn", t = 1.8},
            {s = "ARC9_Ghosts.AK12_Chamber", t = 2.5},
        },
    },
    ["enter_sprint"] = {
        Source = "sprint_in",
