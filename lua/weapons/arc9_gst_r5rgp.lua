...
SWEP.ViewModel = "models/weapons/arc9/c_gst_r5rgp.mdl"
SWEP.WorldModel = "models/weapons/w_rif_m4a1.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/c_gst_r5rgp.mdl"
...
local ironsightpos = Vector(-2.825, -2, 0.4)
...
SWEP.HookP_NameChange = function(self, name)
    ...
    local gunname = "Remington R5 RGP"

    if attached["bo1_pap"] then
        gunname = "Ruinous Grim Punisher"
    end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        Time = 1.5,
        EventTable = {
            {s = "ARC9_Ghosts.R5RGP_Lift", t = 1 / 60},
            {s = "ARC9_Ghosts.R5RGP_FirstDraw", t = 15 / 60},
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "ARC9_Ghosts.R5RGP_MagOut", t = 0.25},
            {s = "ARC9_Ghosts.R5RGP_MagIn", t = 1.3},
        },
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        EventTable = {
            {s = "ARC9_Ghosts.R5RGP_MagOut", t = 0.25},
            {s = "ARC9_Ghosts.R5RGP_MagIn", t = 1.3},
            {s = "ARC9_Ghosts.R5RGP_Chamber", t = 2},
        },
    },
    ["enter_sprint"] = {
        Source = "sprint_in",
