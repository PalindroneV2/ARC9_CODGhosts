...
SWEP.ViewModel = "models/weapons/arc9/c_gst_honeybadger.mdl"
SWEP.WorldModel = "models/weapons/w_rif_m4a1.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/c_gst_honeybadger.mdl"
...
SWEP.HookP_NameChange = function(self, name)
    ...
    local gunname = "AAC Honey Badger"

    if attached["bo1_pap"] then
        gunname = "MVP Wolverine"
    end
...
SWEP.Animations = {
    ...
    ["draw"] = {
        ...
        Time = 1.73,
        EventTable = {
            {s = "ARC9_Ghosts.Badger_Lift", t = 1 / 60},
            {s = "ARC9_Ghosts.Badger_Grab", t = 5 / 60},
            {s = "ARC9_Ghosts.Badger_Stock", t = 30 / 60},
        },
    },
    -- ["draw"] = {
    --     Source = "draw",
