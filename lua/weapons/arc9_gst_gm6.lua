...
SWEP.Category = "ARC9 - COD: Ghosts" -- Updated to match the game source
SWEP.SubCategory = "Sniper Rifles"
SWEP.AdminOnly = false

SWEP.PrintName = "GM6 Lynx"
SWEP.Class = "Anti-Materiel Precision Rifle"
SWEP.Description = [[Hungarian semi-automatic bullpup sniper rifle. Features a unique long-recoil action that significantly reduces the kick of its massive .50 BMG rounds.]]
SWEP.Trivia = {
    Manufacturer = "Sero International",
    Calibre = ".50 BMG",
    Mechanism = "Long Recoil, Semi-Automatic",
    Country = "Hungary",
    Year = 2010,
...
SWEP.ViewModel = "models/weapons/arc9/c_gst_gm6.mdl"
SWEP.WorldModel = "models/weapons/w_snip_awp.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/c_gst_gm6.mdl"
...
SWEP.ShootSound = "ARC9_Ghosts.GM6_Fire"
SWEP.ShootSoundSilenced = "ARC9_Ghosts.GM6_Sil"
...
SWEP.CustomizePos = Vector(25, 35, 4)
...
SWEP.Attachments = {
    {
        PrintName = "Optic",
        Bone = "j_gun",
        Pos = Vector(9.5, 0, 5.26),
        Ang = Angle(0, 0, 0),
        Category = {"cod_optic"},
        InstalledElements = {"mount"},
        Installed = "gst_optic_gm6",
    },
    {
        PrintName = "Muzzle",
        Bone = "barrel0_jnt",
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        Time = 137 / 30,
        EventTable = {
            {s = "ARC9_Ghosts.GM6_Lift", t = 1 / 60},
            {s = "ARC9_Ghosts.GM6_MagOut", t = 25 / 30},
            {s = "ARC9_Ghosts.GM6_MagIn", t = 62 / 30},
            {s = "ARC9_Ghosts.GM6_Hit", t = 77 / 30},
            {s = "ARC9_Ghosts.GM6_Lift", t = 90 / 30},
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            {s = "ARC9_Ghosts.GM6_MagIn", t = 62 / 30},
            {s = "ARC9_Ghosts.GM6_Hit", t = 77 / 30},
            {s = "ARC9_Ghosts.GM6_Chamber", t = 95 / 30},
            {s = "ARC9_Ghosts.GM6_Lift", t = 120 / 60},
        },
        IKTimeLine = {
            {
                t = 0,
