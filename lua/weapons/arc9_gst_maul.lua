...
SWEP.ViewModel = "models/weapons/arc9/c_gst_maul.mdl"
SWEP.WorldModel = "models/weapons/w_shot_xm1014.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/c_gst_maul.mdl"
...
SWEP.HookP_NameChange = function(self, name)
    ...
    local gunname = "Metal Storm MAUL"
    if attached["bo1_pap"] then
        gunname = "Grapeshot Musket"
    end
